...
-- =====================================================================
-- SISTEMA DE TRADUÇÃO / TRANSLATION SYSTEM / HỆ THỐNG DỊCH
-- Detecta idioma automaticamente. Pode ser forçado via _G.TRonLanguage
-- =====================================================================
local _TRANSLATIONS = {
	["pt"] = {
		["Tab | Discord"] = "Tab | Discord",
		["Tab | Status and Server"] = "Tab | Status e Servidor",
		["Tab | Settings"] = "Tab | Configurações",
		["Tab | Sea Settings"] = "Tab | Config. do Mar",
		["Tab | Shop"] = "Tab | Loja",
		["Tab | Main Farm"] = "Tab | Farm Principal",
		["Tab | Multi Farm"] = "Tab | Multi Farm",
		["Tab | Others"] = "Tab | Outros",
		["Tab | Farming and Hop"] = "Tab | Farm e Hop",
		["Tab | Items"] = "Tab | Itens",
		["Tab | Fruit"] = "Tab | Fruta",
		["Tab | Raid"] = "Tab | Raid",
		["Tab | Combat"] = "Tab | Combate",
		["Tab | Race"] = "Tab | Raça",
		["Tab | Dragon Dojo"] = "Tab | Dragon Dojo",
		["Tab | Sea Event"] = "Tab | Evento do Mar",
		["Tab | Islands"] = "Tab | Ilhas",
		["Tab | Esp"] = "Tab | ESP",
		["Tab | Teleport"] = "Tab | Teleporte",
		["Tab | Local Player"] = "Tab | Jogador Local",
		["Tab | Stats"] = "Tab | Stats",
		["Tab | Misc"] = "Tab | Misc",
		["Auto Fully Volcanic Island"] = "Auto Fully Volcanic Island",
		["Auto Reset When Completed"] = "Auto Reset ao Completar",
		["Auto Collect Eggs"] = "Auto Coletar Ovos",
		["Auto Collect Bones"] = "Auto Coletar Ossos",
		["Tween To Fruit"] = "Tween Para Fruta",
		["Teleport To Fruit"] = "Teleporte Para Fruta",
		["Fruit Notification"] = "Notificação de Fruta",
		["Grab Fruit"] = "Pegar Fruta",
		["Fruit found"] = "Fruta encontrada!",
		["Server Hop"] = "Trocar Servidor",
		["Rejoin Server"] = "Entrar Novamente",
		["Auto Farm"] = "Auto Farm",
		["Language"] = "Idioma",
		["Language Desc"] = "Selecione o idioma da interface",
		["Settings"] = "Configurações",
		["Boat Selection"] = "Seleção de Barco",
		["Multi Farm"] = "Multi Farm",
	},
	["en"] = {
		["Tab | Discord"] = "Tab | Discord",
		["Tab | Status and Server"] = "Tab | Status & Server",
		["Tab | Settings"] = "Tab | Settings",
		["Tab | Sea Settings"] = "Tab | Sea Settings",
		["Tab | Shop"] = "Tab | Shop",
		["Tab | Main Farm"] = "Tab | Main Farm",
		["Tab | Multi Farm"] = "Tab | Multi Farm",
		["Tab | Others"] = "Tab | Others",
		["Tab | Farming and Hop"] = "Tab | Farming & Hop",
		["Tab | Items"] = "Tab | Items",
		["Tab | Fruit"] = "Tab | Fruit",
		["Tab | Raid"] = "Tab | Raid",
		...
		["Tab | Islands"] = "Tab | Islands",
		["Tab | Esp"] = "Tab | Esp",
		["Tab | Teleport"] = "Tab | Teleport",
		["Tab | Local Player"] = "Tab | Local Player",
		["Tab | Stats"] = "Tab | Stats",
		["Tab | Misc"] = "Tab | Misc",
		["Auto Fully Volcanic Island"] = "Auto Fully Volcanic Island",
		["Auto Reset When Completed"] = "Auto Reset When Completed",
		["Auto Collect Eggs"] = "Auto Collect Eggs",
		["Auto Collect Bones"] = "Auto Collect Bones",
		["Tween To Fruit"] = "Tween To Fruit",
		["Teleport To Fruit"] = "Teleport To Fruit",
		["Fruit Notification"] = "Fruit Notification",
		["Grab Fruit"] = "Grab Fruit",
		["Fruit found"] = "Fruit found!",
		...
		["Settings"] = "Settings",
		["Boat Selection"] = "Boat Selection",
		["Multi Farm"] = "Multi Farm",
	},
	["vi"] = {
		["Tab | Discord"] = "Tab | Discord",
		["Tab | Status and Server"] = "Tab | Trạng Thái & Server",
		["Tab | Settings"] = "Tab | Cài Đặt",
		["Tab | Sea Settings"] = "Tab | Cài Đặt Biển",
		["Tab | Shop"] = "Tab | Cửa Hàng",
		["Tab | Main Farm"] = "Tab | Farm Chính",
		["Tab | Multi Farm"] = "Tab | Đa Farm",
		["Tab | Others"] = "Tab | Khác",
		["Tab | Farming and Hop"] = "Tab | Farm & Nhảy Server",
		["Tab | Items"] = "Tab | Vật Phẩm",
		["Tab | Fruit"] = "Tab | Trái Cây",
		["Tab | Raid"] = "Tab | Raid",
		["Tab | Combat"] = "Tab | Chiến Đấu",
		["Tab | Race"] = "Tab | Chủng Tộc",
		["Tab | Dragon Dojo"] = "Tab | Dragon Dojo",
		["Tab | Sea Event"] = "Tab | Sự Kiện Biển",
		["Tab | Islands"] = "Tab | Đảo",
		["Tab | Esp"] = "Tab | ESP",
		["Tab | Teleport"] = "Tab | Dịch Chuyển",
		["Tab | Local Player"] = "Tab | Người Chơi",
		["Tab | Stats"] = "Tab | Chỉ Số",
		["Tab | Misc"] = "Tab | Linh Tinh",
		["Auto Fully Volcanic Island"] = "Tự Động Volcanic Island",
		["Auto Reset When Completed"] = "Tự Động Reset Khi Xong",
		["Auto Collect Eggs"] = "Tự Động Nhặt Trứng",
		["Auto Collect Bones"] = "Tự Động Nhặt Xương",
		["Tween To Fruit"] = "Di Chuyển Đến Trái",
		["Teleport To Fruit"] = "Dịch Chuyển Đến Trái",
		["Fruit Notification"] = "Thông Báo Trái Cây",
		["Grab Fruit"] = "Lấy Trái",
		["Fruit found"] = "Tìm thấy trái!",
		...
		["Settings"] = "Cài Đặt",
		["Boat Selection"] = "Chọn Thuyền",
		["Multi Farm"] = "Đa Farm",
	},
	["es"] = {
		["Tab | Discord"] = "Tab | Discord",
		["Tab | Status and Server"] = "Tab | Estado y Servidor",
		["Tab | Settings"] = "Tab | Ajustes",
		["Tab | Sea Settings"] = "Tab | Config. del Mar",
		["Tab | Shop"] = "Tab | Tienda",
		["Tab | Main Farm"] = "Tab | Farm Principal",
		["Tab | Multi Farm"] = "Tab | Multi Farm",
		["Tab | Others"] = "Tab | Otros",
		["Tab | Farming and Hop"] = "Tab | Farm y Salto",
		["Tab | Items"] = "Tab | Objetos",
		["Tab | Fruit"] = "Tab | Fruta",
		["Tab | Raid"] = "Tab | Raid",
		["Tab | Combat"] = "Tab | Combate",
		["Tab | Race"] = "Tab | Raza",
		["Tab | Dragon Dojo"] = "Tab | Dragon Dojo",
		["Tab | Sea Event"] = "Tab | Evento del Mar",
		["Tab | Islands"] = "Tab | Islas",
		["Tab | Esp"] = "Tab | ESP",
		["Tab | Teleport"] = "Tab | Teletransporte",
		["Tab | Local Player"] = "Tab | Jugador Local",
		["Tab | Stats"] = "Tab | Estadísticas",
		["Tab | Misc"] = "Tab | Misc",
		["Auto Fully Volcanic Island"] = "Auto Isla Volcánica",
		["Auto Reset When Completed"] = "Auto Reset al Completar",
		["Auto Collect Eggs"] = "Auto Recoger Huevos",
		["Auto Collect Bones"] = "Auto Recoger Huesos",
		["Tween To Fruit"] = "Mover Hacia Fruta",
		["Teleport To Fruit"] = "Teletransportarse a Fruta",
		["Fruit Notification"] = "Notificación de Fruta",
		["Grab Fruit"] = "Agarrar Fruta",
		["Fruit found"] = "¡Fruta encontrada!",
		["Server Hop"] = "Cambiar Servidor",
		["Rejoin Server"] = "Reconectar",
		["Auto Farm"] = "Farm Automático",
		["Language"] = "Idioma",
		["Language Desc"] = "Selecciona el idioma",
		["Settings"] = "Ajustes",
		["Boat Selection"] = "Selección de Barco",
		["Multi Farm"] = "Multi Farm",
	},
	["zh"] = {
		["Tab | Discord"] = "标签 | Discord",
		["Tab | Status and Server"] = "标签 | 状态与服务器",
		["Tab | Settings"] = "标签 | 设置",
		["Tab | Sea Settings"] = "标签 | 海洋设置",
		["Tab | Shop"] = "标签 | 商店",
		["Tab | Main Farm"] = "标签 | 主农场",
		["Tab | Multi Farm"] = "标签 | 多农场",
		["Tab | Others"] = "标签 | 其他",
		["Tab | Farming and Hop"] = "标签 | 农场与跳服",
		["Tab | Items"] = "标签 | 物品",
		["Tab | Fruit"] = "标签 | 果实",
		["Tab | Raid"] = "标签 | 副本",
		["Tab | Combat"] = "标签 | 战斗",
		["Tab | Race"] = "标签 | 种族",
		["Tab | Dragon Dojo"] = "标签 | 龙道场",
		["Tab | Sea Event"] = "标签 | 海洋事件",
		["Tab | Islands"] = "标签 | 岛屿",
		["Tab | Esp"] = "标签 | ESP",
		["Tab | Teleport"] = "标签 | 传送",
		["Tab | Local Player"] = "标签 | 本地玩家",
		["Tab | Stats"] = "标签 | 属性",
		["Tab | Misc"] = "标签 | 杂项",
		["Auto Fully Volcanic Island"] = "自动完整火山岛",
		["Auto Reset When Completed"] = "完成后自动重置",
		["Auto Collect Eggs"] = "自动收集蛋",
		["Auto Collect Bones"] = "自动收集骨头",
		["Tween To Fruit"] = "移动到果实",
...
-- Detecta idioma automaticamente pelo Roblox LocaleId
local function _detectLang()
	local ok, locale = pcall(function()
		return game:GetService("LocalizationService").RobloxLocaleId or "";
	end);
	if not ok then return "en" end;
	local l = tostring(locale):lower();
	if l:find("pt") then return "pt"
	elseif l:find("vi") then return "vi"
	elseif l:find("es") then return "es"
	elseif l:find("zh") then return "zh"
	elseif l:find("en") then return "en"
	else return "en" end;
end;

-- Permite forçar idioma via _G.TRonLanguage antes de carregar
_G.TRonLang = _G.TRonLang or _detectLang();

local function T(key)
	local tbl = _TRANSLATIONS[_G.TRonLang] or _TRANSLATIONS["en"];
	return tbl[key] or _TRANSLATIONS["en"][key] or key;
end;
-- =====================================================================
...
Tabs.InfoTab:Paragraph({
	Title = " Credits",
	Desc = "Dev: MutanoZS\nOwner: KettyS\n\nTRon Void Hub R6.0 — Blox Fruits"
});
...
-- Só restaura se nenhuma funcao de farm ativa precisar do HRP ancorado
task.spawn(function()
	while true do
		task.wait(2);
		pcall(function()
...
-- Vetores de dodge ao redor do boss (evita ataques em área)
	...
	while task.wait(0.05) do
		...
		pcall(function()
			...
			if boss and boss:FindFirstChild("Humanoid") and boss.Humanoid.Health > 0 then
				...
				-- Dodge contínuo: alterna posições ao redor do boss
				local now = tick();
...
local function _buyBoatAtTiki(boatName)
	pcall(function()
		...
		if not hrp then return; end;
		local dist = (hrp.Position - _TIKI_BOAT_NPC_VOL_CF.Position).Magnitude;
		if dist > 3000 then
			hrp.CFrame = _TIKI_BOAT_NPC_VOL_CF;
		else
			...
			if boat then
				...
				if seat and hrp then
					if not hum.Sit then
						...
						TweenBoat(_VOLCANIC_ISLAND_SAIL_CF);
					end;
				end;
			else
...
-- Auto Sail (Motor Eclipse - sistema novo com eventos do mar)
...
task.spawn(function()
	while task.wait(0.5) do
		...
		pcall(function()
			...
			-- Senta no barco se não estiver sentado
			if not hum.Sit then
				local seat = boat:FindFirstChildWhichIsA("VehicleSeat");
				if seat then
...
-- Bring Boat: Teleporta o barco até o jogador (evento do mar)
Tabs.SeaEventTab:Button({
	Title = "Bring Boat",
	Desc = "Teleporta o barco selecionado até a sua posição atual.",
	Callback = function()
		pcall(function()
			local selectedBoat = _G.Settings.SeaEvent["Selected Boat"] or "Guardian";
			local boat = workspace.Boats:FindFirstChild(selectedBoat);
